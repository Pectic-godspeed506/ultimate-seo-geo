...
cp "$SCRIPT_DIR/.claude-plugin/marketplace.json"                      .claude-plugin/marketplace.json
cp "$SCRIPT_DIR/plugins/ultimate-seo-geo/.claude-plugin/plugin.json"  plugins/ultimate-seo-geo/.claude-plugin/plugin.json
cp "$SCRIPT_DIR/plugins/ultimate-seo-geo/README.md"                   plugins/ultimate-seo-geo/README.md
cp "$SCRIPT_DIR/.github/workflows/validate-plugin.yml"                .github/workflows/validate-plugin.yml
